...
$dbServer = "localhost"; // Assuming MySQL is hosted locally
$dbUsername = "root";
$dbPassword = ""; // Password for MySQL, empty in this case
$dbName = "backrv";
...
$sql = "SELECT * FROM your_table_name"; // Change your_table_name with the actual table name
