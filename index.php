...
if (isset($_SESSION['success_message'])) {
    ...
    unset($_SESSION['success_message']); // Remove the success message from session to prevent displaying it again on refresh
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_insert_message = "INSERT INTO messages (sender_username, sender_email, subject, message) VALUES ('$sender_name', '$sender_email', '$subject', '$message')";
            ...
            <div class="col-lg-12">
              <form id="contact" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <fieldset>
                      <input name="sendername" type="text" id="sendername" placeholder="YOURNAME...*" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-4">
                    <fieldset>
