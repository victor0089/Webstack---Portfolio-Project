...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM meetings WHERE id = $meeting";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("Location: editmeeting.php?error=user_not_found");
        exit();
    }
} else {
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								<a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
									<img src="uploads/<?php echo $imagePath; ?>" alt="">John Doe
								</a>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
                    <form id="edit_meeting_form" data-parsley-validate class="form-horizontal form-label-left" action="updatemeeting.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="id" value="<?php echo $meeting['id']; ?>">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" id="meeting_date" name="meeting_date" required="required" class="form-control " value="<?php echo $meeting['meeting_date']; ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="titlee" name="titlee" required="required" class="form-control "value="<?php echo $meeting['title']; ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" class="form-control" value="<?php echo $meeting['content']; ?>">Contents</textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="location" class="col-form-label col-md-3 col-sm-3 label-align">Location <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="location" class="form-control" type="text" name="location" required="required" value="<?php echo $meeting['location']; ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="price" class="col-form-label col-md-3 col-sm-3 label-align">Price <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="price" class="form-control" type="number" name="price" required="required" value="<?php echo $meeting['price']; ?>">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="active1">
												</label>
											</div>
										</div>
										<div class="item form-group">
