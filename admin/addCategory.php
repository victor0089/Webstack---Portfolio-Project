...
$category_name_err = ""; // Initialize the variable
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="item form-group <?php echo (!empty($category_name_err)) ? 'has-error' : ''; ?>">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="add-category">Add Category <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="add-category" required="required" class="form-control " name="category_name" value="<?php echo $category_name; ?>">
