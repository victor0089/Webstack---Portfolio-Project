...
if (!isset($_SESSION['username'])) {
    ...
    // Validate username (you can adjust the validation criteria)
    ...
    // Handle the error or redirect the user
    exit("Username not set or empty");
}
...
// Sanitize and validate $_SESSION['username']
$_SESSION['login_time'] = time(); // Store the current timestamp as login time
// Check session timeout (e.g., 30 minutes)
$session_timeout = 1 * 60; // 30 minutes in seconds
...
// Update login time on every page load to extend the session
$_SESSION['login_time'] = time();

include 'db_connection.php';

// SQL query to get meetings data
$sql = "SELECT * FROM meetings"; // Change "meetings" to your actual table name
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<td><a href='editmeeting?id=" . $row['id'] . "'><img src='./images/edit.png' alt='Edit'></a></td>";
                                                        echo "<td><a href='deletmeet.php?id=" . $row['id'] . "' onclick=\"return confirm('Are you sure you want to delete this meeting?')\"><img src='./images/delete.png' alt='Delete'></a></td>";
                                                        echo "</tr>";
                                                    }
                                                }
                                                ?>
