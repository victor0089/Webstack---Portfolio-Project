...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO users (full_name, username, email, password, active) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssi", $full_name, $username, $email, $password, $active);
...
<form id="demo-form2" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" data-parsley-validate class="form-horizontal form-label-left">
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 ">
            <input type="text" id="full-name" name="full_name" required="required" class="form-control">
        </div>
    </div>
    <div class="item form-group">
