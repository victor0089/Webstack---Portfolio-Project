...
$username = "root";
$password = ""; // If you have a password, please replace it with your actual password
$dbname = "backrv";
...
// Prepare SQL query
$stmt = $conn->prepare("INSERT INTO meetings (title, meeting_date, time, description) VALUES (?, ?, ?, ?)");
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Vicoooo
                  </a>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="time">Time <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="time" id="time" name="time" required="required" class="form-control ">
                        </div>
                      </div>
                      <div class="item form-group">
