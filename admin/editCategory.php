...
if(isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        // category found, display the form to edit user information
        $category = mysqli_fetch_assoc($result);
    } else {
        // User not found, redirect to a page indicating the error
        header("Location: categories.php?error=user_not_found");
        exit();
    }
} else {
    // ID not provided, redirect to a page indicating the error
    header("Location: categories.php?error=id_not_provided");
    exit();
}
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="updatecategory.php" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="category-name" name="category-name" required="required" class="form-control " value="<?php echo $category['category_name']; ?>">
											 <input type="hidden" name="id" value="<?php echo $category['id']; ?>"> <!-- Add a hidden input field for category ID -->
											</div>
										</div>
